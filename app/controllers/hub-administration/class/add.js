...
export default class HubAdministrationClassAddController extends Controller {
  @service data
  orgs = organizations
  states = states
  ...
  async save () {
    ...
    success('Successfully created class. It should show up in the hub momentarily.');
